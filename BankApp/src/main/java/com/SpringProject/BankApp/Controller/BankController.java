package com.SpringProject.BankApp.Controller;
...
public class BankController {
    ...
    public String transferAccount(@RequestParam String toUsername, @RequestParam BigDecimal amount,Model model)
    {
        String username = SecurityContextHolder.getContext().getAuthentication().getName();
        Account fromAccount = accountService.findByAccountUsername(username);

        try {
            accountService.transferAccount(fromAccount, toUsername, amount);
        }catch (RuntimeException e)
        {
            model.addAttribute("error",e.getMessage());
